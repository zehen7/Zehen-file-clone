...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1m Imtiaz Zehen 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801940059100
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1m Death Cyber Team
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/Remember.This.Name.ARIY4N")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ZEHEN] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ZEHEN-CP] %s|%s        '%(b,idf,pw))
